...
function Footer() {
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(0deg, rgba(58,180,177,0.364670868347339) 55%, rgba(255,255,255,0) 90%)",
      }}
    >
        ...
        <div className="col w-full h-auto flex flex-col lg:flex-row items-center justify-center p-12 gap-12 lg:gap-24">
          <div className="row flex items-center justify-center flex-col gap-4 w-full lg:w-auto">
            ...
            <div className={`lg:flex ${activeSection === 1 ? "flex" : "hidden"} flex-col text-start gap-2 lg:text-left`}>
              ...
              <Link to="about"  className="text-grey font-light text-md">Testimonial</Link>
            </div>
          </div>
          <div className="row flex items-center justify-center flex-col gap-4 w-full lg:w-auto">
            <h2
            ...
            >
              Resources
              <IoIosArrowDown
                className={`lg:hidden transition-transform duration-300 ${activeSection === 2 ? "transform rotate-180" : ""}`}
              />
            </h2>
            <div className={`lg:flex ${activeSection === 2 ? "flex" : "hidden"} flex-col text-start gap-2 lg:text-left`}>
              <Link to="about" className="text-grey font-light text-md">Privacy Policy</Link>
              <Link to="about"  className="text-grey font-light text-md">Terms and Condition</Link>
              <Link to="blog"  className="text-grey font-light text-md">Blog</Link>
              <Link to="contact"  className="text-grey font-light text-md">Contact us</Link>
            </div>
          </div>
          <div className="row flex items-center justify-center flex-col gap-4 w-full lg:w-auto">
            <h2
            ...
            >
              Product
              <IoIosArrowDown
                className={`lg:hidden transition-transform duration-300 ${activeSection === 3 ? "transform rotate-180" : ""}`}
              />
            </h2>
            <div className={`lg:flex ${activeSection === 3 ? "flex" : "hidden"} flex flex-col text-start gap-2 lg:text-left`}>
              <Link to="product" className="text-grey font-light text-md">Project management</Link>
              <Link to="product" className="text-grey font-light text-md">Time tracker</Link>
              <Link to="product" className="text-grey font-light text-md">Time schedule</Link>
              <Link to="about" className="text-grey font-light text-md">Remote Collaboration</Link>
            </div>
          </div>
          <div className="row flex items-center justify-center flex-col gap-6 text-center w-full lg:w-auto">
            ...
            <div className="flex items-center lg:items-start justify-center flex-col gap-3 w-full">
              ...
              <form className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 bg-input rounded-md w-full max-w-md">
                <input
                  type="email"
